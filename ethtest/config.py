...
class DatabaseConfig:
    uri: str = os.getenv('DATABASE_URI', 'sqlite:///ETH.db')
...
# Multi-account configuration is kept as a dictionary.
_ACCOUNTS = {
    "MAIN": {
        "active": os.getenv("MAIN_ACTIVE", "True").lower() == "true",
        "API_KEY": os.getenv("DELTA_API_KEY", "fGQsRZrluE94QnGNQen8z90pPW1I5s"),
        "API_SECRET": os.getenv("DELTA_API_SECRET", "FXdGYpi7uUqez7NslLUao4QsIiTWIdcrnjv2AHrJbCZt4WBpgBc5EDXKC01w"),
