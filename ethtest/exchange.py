...
class DeltaExchangeClient:
    def __init__(self, account: str = "MAIN"):
        ...
        The provided account must be marked as active in the configuration.
        """
    ...
    def load_markets(self, reload: bool = False):
        """
        Loads markets from the exchange. Uses cached markets if available and fresh.
        """
    ...
    def create_limit_order(self, symbol, side, amount, price, params=None):
        """
        Creates a limit order for the given symbol, side, amount, and price.
        """
        try:
    ...
    def create_order(self, symbol, order_type, side, amount, price=None, params=None):
        """
        Creates an order of the specified type. If price is provided, it is used.
        """
        try:
    ...
    def modify_bracket_order(self, order_id, product_id, product_symbol, bracket_params):
        """
        Modifies a bracket order by updating the bracket parameters.
        """
        request_body = {"id": order_id, "product_id": product_id, "product_symbol": product_symbol}
