...
_ACCOUNTS = {
    "MAIN": {
        ...
        "API_KEY": os.getenv("DELTA_API_KEY", "woi6K2SqYM4pxucKKSyiWHC4otjhCG"),
        "API_SECRET": os.getenv("DELTA_API_SECRET", "SbQPy3H8WArxN5SWguou3hgp9y1preJRgWkaEjTcwEgADLLqe55UlGBhBWS1"),
